...
public class DomicilioController {
	...
	@GetMapping("/obtenerDomiclioPorAlumno")
	@ResponseBody
	public Domicilio obtenerDomiclioPorAlumno(Authentication auth) {
		String correo = auth.getName();
		Usuario u = serviceUsuario.buscarPorCorreo(correo);
		Alumno a = serviceAlumno.buscarPorUsuario(u);
		System.out.println("Prueba: " + a);
		return serviceDomicilio.buscarPorId(a.getDomicilio().getIdDomicilio());
	}
}
