...
public class MiFamiliaService {
	...
	@Autowired
	private MediosEstudiosService mediosEstudiosService ;
	
	@Autowired
	private InfoFamiliaService infoFamiliaService ;
	...
	@Autowired
	private ViviendaFamiliarService viviendaFamiliarService;
	
	@Autowired
	private ServiciosViviendaService serviciosViviendaService;
