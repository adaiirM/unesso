...
import com.example.unesso.controller.services.SolicitarBecaService;
...
public class AlumnoController {
	...
	@Autowired
	private SolicitarBecaService solicitarBecaService;
	...
	@GetMapping("/solicitarBeca")
	public String solicitarBeca(Model model,Authentication authentication){
		EstadoFormularios estadoFormularios = solicitarBecaService.getEstadoFormularios(authentication);
